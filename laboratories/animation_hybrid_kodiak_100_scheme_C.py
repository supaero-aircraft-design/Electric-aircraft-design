...
if __name__ == "__main__":
    ...
    path_to_powertrain_description_file = pathlib.Path(DATA_FOLDER_PATH) / "hybrid_kodiak_100_scheme_C_propulsive_architecture.yml"
    path_to_network_viewer_file = pathlib.Path(RESULT_FOLDER_PATH) / "hybrid_kodiak_100_scheme_C_network_viewer.html"
